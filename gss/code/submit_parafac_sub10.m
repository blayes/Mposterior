...
train = csvread(strcat('../data/csv_train/sub10/', num2str(nrepf), '/train_', num2str(nsubf), '.csv'));
...
save(strcat('/Shared/ssrivastva/gss/data/sub10/', num2str(nrepf), '/res_sub_', num2str(nsubf), '.mat'), 'history', 'tend', 'lambda0');    
csvwrite(strcat('/Shared/ssrivastva/gss/data/sub10/', num2str(nrepf), '/lambda0_', num2str(nsubf), '.csv'), lambda0);
csvwrite(strcat('/Shared/ssrivastva/gss/data/sub10/', num2str(nrepf), '/time_', num2str(nsubf), '.csv'), tend);
